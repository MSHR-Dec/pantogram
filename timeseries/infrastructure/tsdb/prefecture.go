...
func NewPrefectureRepository(d influxdb2.Client, name string) repository.PrefectureRepository {
...
func (r *PrefectureRepository) Save(t map[string]string, f map[string]interface{}, n time.Time) {
